'use strict';
/* build-hook-start *//*00001*/try { require('/root/.vscode-server/extensions/wallabyjs.console-ninja-1.0.460/out/buildHook/index.js').default({tool: 'jest', checkSum: '201b115522d0836bf3f87bA1YfCBsFCAEGBAtXUFoAUgQODwRS', mode: 'build'}); } catch(cjsError) { try { import('file:///root/.vscode-server/extensions/wallabyjs.console-ninja-1.0.460/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '201b115522d0836bf3f87bA1YfCBsFCAEGBAtXUFoAUgQODwRS', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
